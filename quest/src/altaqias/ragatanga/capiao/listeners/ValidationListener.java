...
public class ValidationListener implements SystemEventListener {
	 ...
	 * todos os componentes que são "UIInput".
	 */
	 ...
	 * 
	 * A lógica desse método leva em conta que as classes CSS podem ser separadas
	 * por espaço em branco ou virgulas, como manda a especificação JSF.
	 */
	 ...
	 * Esse teste serve para garantir que mesmo validações feitas
	 * "na mão", na fase "INVOKE APPLICATION", destaque
